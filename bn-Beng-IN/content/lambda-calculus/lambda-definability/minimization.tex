...
% BN-SRC-317 TARGET-CORRECTION-BEGIN
\par\smallskip\noindent\textnormal{\small\textbf{উৎস-সংশোধন (BN-SRC-317):} হিমায়িত $\fn{Search}$-এর পুনরাবৃত্ত শাখা~$g\,\vec{x}(\fn{Succ}\,y)$ আবদ্ধ উপস্থাপক~$f$-কে বাদ দেয়; ফলে $R=Y\,\fn{Search}$ ধরলে শাখাটি প্রমাণে ব্যবহৃত $R\,F\,\vec{x}(\fn{Succ}\,y)$ নয়, ভুলভাবে $R\,\vec{x}(\fn{Succ}\,y)$ দেয়। বাংলা সূত্রে পুনরাবৃত্ত ডাকটি $g\,f\,\vec{x}(\fn{Succ}\,y)$ করা হয়েছে, যাতে একই~$f$ পরের অনুসন্ধান ধাপে বহন করা হয়।} % BN-SRC-317 TARGET-CORRECTION-END
  ...
  একই উপস্থাপক ও $\fn{Succ}\, y$ দিয়ে নিজেকেই আবার ডাকো। অতএব $(Y \, \fn{Search}) F
