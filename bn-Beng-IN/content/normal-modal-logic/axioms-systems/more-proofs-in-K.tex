...
\olsection{\Log{K}-তে আরও প্রমাণ}

এবার \olref[der]{sec}-এ চালু করা সংক্ষিপ্ত পদ্ধতি ব্যবহার করে~\Log{K}-তে !!{derivability}-এর আরও কয়েকটি উদাহরণ দেখি।
...
5. &  $\Log{K} \Proves \Box(!A \lif !B) \lif (\Diamond!A \lif \Diamond!B)$ & $\lnot\Box\lnot$-এর বদলে $\Diamond$।
\end{derivation}
\end{proof}
...
\begin{proof}
  ...
  \Diamond !B)$ & $\lnot\Box\lnot$-এর বদলে $\Diamond$।
  \end{derivation}
\end{proof}
...
\begin{proof}
  \begin{derivation}
    ...
    $\lnot\Box\lnot$-এর বদলে $\Diamond$\\
    5. & $\Log{K} \Proves \Diamond!B \lif \Diamond(!A \lor !B)$ & একইভাবে\\
...
\begin{proof}
  \begin{derivation}
    ...
    \Diamond!B \lif \Diamond!A)$ & $\lnot\Box\lnot$-এর বদলে $\Diamond$\\
    7. & $\Log{K} \Proves \Diamond(!A\lor!B) \lif (\Diamond!B \lor \Diamond!A)$ & \PL, 6। \\
  \end{derivation}
\end{proof}

\begin{prob}
  নিচের !!{derivability}-সংক্রান্ত দাবিগুলি প্রমাণ করুন:
  \begin{enumerate}
