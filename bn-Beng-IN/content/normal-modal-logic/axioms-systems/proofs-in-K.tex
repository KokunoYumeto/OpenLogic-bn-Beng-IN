...
\olsection{\Log{K}-তে প্রমাণ}

ক্ষুদ্রতম মোডাল পদ্ধতিতে প্রমাণের অভ্যাসের জন্য দেখাব যে \olref[syn][sch]{tab:valid-invalidSchemas}-এর বাম পাশে থাকা বৈধ !!{formula}s-এর প্রত্যেকটির \Log{K}-প্রমাণ দেওয়া যায়।
...
\end{derivation}
লক্ষ করুন, $9$ নম্বর পংক্তির !!{formula} নিচের সর্বতঃসত্য সূত্রের একটি উদাহরণ:
\[
...
\begin{proof}
  ...
  \end{derivation}
  $6$ ও $9$ নম্বর পংক্তির !!{formula}s যথাক্রমে নিচের সর্বতঃসত্য সূত্রগুলির উদাহরণ:
  \begin{align*}
...
\begin{proof}
  ...
  \end{derivation}
  $8$ ও $10$ নম্বর পংক্তির !!{formula}s যথাক্রমে নিচের সর্বতঃসত্য সূত্রগুলির উদাহরণ:
  \begin{align*}
  ...
  \end{derivation}
  শেষ পংক্তিটি $\lnot \Box p \lif \Diamond\lnot p$, কারণ $\Diamond$-এর সংজ্ঞা হলো $\lnot\Box\lnot$। $5$ নম্বর পংক্তির !!{formula} নিচের সর্বতঃসত্য সূত্রের একটি উদাহরণ:
  \[
    (p \lif q) \lif (\lnot q \lif \lnot p).
  \]
  }}{% Box is defined
  ...
  \end{derivation}
  $4$ নম্বর পংক্তির !!{formula} নিচের সর্বতঃসত্য সূত্রের একটি উদাহরণ:
  \begin{align*}
...
\begin{prob}
  নিচের !!{formula}s-এর জন্য~$\Log{K}$-তে !!{derivation}s নির্ণয় করুন:
  \begin{enumerate}
