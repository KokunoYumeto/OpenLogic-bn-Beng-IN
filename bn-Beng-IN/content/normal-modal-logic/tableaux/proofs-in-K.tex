...
\olsection{\Log{K}-এর জন্য \usetoken{P}{tableau}}

\iftag{prvBox}{

\begin{ex}
  $\Proves (\Box!A \land \Box!B)
  \lif \Box (!A \land !B)$ দেখায় এমন একটি বদ্ধ ট্যাবলো দিচ্ছি।
  \begin{oltableau}
...
\begin{ex}
  ...
  \lif (\Diamond !A \lor \Diamond !B)$ দেখায় এমন একটি বদ্ধ ট্যাবলো দিচ্ছি:
  \begin{oltableau}
...
\begin{prob}
  নিচের !!{formula}s-এর জন্য~$\Log{K}$-এ বদ্ধ !!{tableau}s নির্মাণ করো:
  \begin{enumerate}
