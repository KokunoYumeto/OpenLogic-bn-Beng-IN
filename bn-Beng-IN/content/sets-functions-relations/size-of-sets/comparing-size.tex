...
\oliflabeldef{sfr:siz:nen:sec}{%
  ...
  \par\smallskip\noindent\textnormal{\small\textbf{উৎস-সংশোধন (BN-SRC-002 / OLSIZ-007):} শেষ সর্বজনীন বক্তব্যে হিমায়িত ইংরেজি উৎসে ``প্রত্যেক $x\in\overline{A}$'' আছে। আগের বাক্যে $x$ যেকোনো $A$-এর উপাদান হিসেবে নেওয়া হয়েছে এবং প্রমাণে দরকারও ``প্রত্যেক $x\in A$''; বাংলা পাঠে সেই সঠিক পরিসরটি ব্যবহার করা হয়েছে।} % BN-SRC-002 TARGET-CORRECTION-END
