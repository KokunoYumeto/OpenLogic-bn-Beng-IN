...
\par\smallskip\noindent\textnormal{\small\textbf{উৎস-সংশোধন (BN-SRC-001):} নিচের প্রথম শাখায় হিমায়িত ইংরেজি উৎসে শূন্য-সেটের যুক্তিতে $g(x)=y$ লেখা হয়েছে, কিন্তু তখনও $g$ সংজ্ঞায়িত হয়নি; প্রয়োজনীয় একৈক সমাপতিত অপেক্ষকটি $f$। বাংলা পাঠে $f(x)=y$ করা হয়েছে।} % BN-SRC-001 TARGET-CORRECTION-END
