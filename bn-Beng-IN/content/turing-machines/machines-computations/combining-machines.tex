...
\end{figure}
% BN-NORM-172 TARGET-NORMALIZATION-BEGIN
\par\smallskip\noindent\textnormal{\small\textbf{উৎস-স্বাভাবিকীকরণ (BN-NORM-172):} এই উদাহরণের হিমায়িত ইংরেজি TikZ কোডে যোগ-যন্ত্রের তিনটি পুনরাবৃত্ত $q_0$-তীরের গন্তব্য হিসেবে $(B)$ লেখা থাকলেও প্রতিটি \texttt{loop above} শৈলী গন্তব্যকে আরম্ভবিন্দুতে পুনর্নির্ধারণ করে; তাই মূল তিনটি চিত্রই $q_0$-র স্ব-আবর্তন আঁকে। বাংলা উৎসে পাঠযোগ্যতার জন্য সমতুল্য গন্তব্য $(A)$ লেখা হয়েছে; এগুলি রেন্ডার করা যন্ত্রের কোনো গাণিতিক সংশোধন নয়।} % BN-NORM-172 TARGET-NORMALIZATION-END
\end{ex}
