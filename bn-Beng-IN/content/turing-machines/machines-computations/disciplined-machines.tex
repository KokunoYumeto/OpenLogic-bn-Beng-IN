...
\end{figure}
% BN-NORM-170 TARGET-NORMALIZATION-BEGIN
\par\smallskip\noindent\textnormal{\small\textbf{উৎস-স্বাভাবিকীকরণ (BN-NORM-170):} হিমায়িত ইংরেজি TikZ কোডে $q_0$-র $\TMstroke$-তীরটির গন্তব্য হিসেবে $(B)$ লেখা থাকলেও \texttt{loop below} শৈলী গন্তব্যকে আরম্ভবিন্দুতে পুনর্নির্ধারণ করে; তাই মূল চিত্রটিও $q_0$-র স্ব-আবর্তন হিসেবেই আঁকা হয়। বাংলা উৎসে পাঠযোগ্যতার জন্য সমতুল্য গন্তব্য $(A)$ লেখা হয়েছে; এটি রেন্ডার করা যন্ত্রের কোনো গাণিতিক সংশোধন নয়।} % BN-NORM-170 TARGET-NORMALIZATION-END
\end{ex}
